...
##I interpreted the NA as a result of missing values or not avaialable within the data set
...
```
##This is useful as it allows us to remove any value seen as NA and give us the calculation we desire. 
